		...
		<Container>
			<Row>
				<div className="text-center col-md-12">
					<h1 className="example">Rhythm 101</h1>
				</div>
			</Row>
			...
			<Row>
				...
				<div className="Text text-center col-md-4">
